...
*
*	Шахматный конь (chess knight) ходит буквой “Г” — на две клетки по вертикали
...
*	3) Для решения достаточно использовать арифметические операции,
...
bool task03(int x1, int y1, int x2, int y2) {
	...
	return (y2 == y1 + 2 && x2 == x1 + 1) || (y2 == y1 + 2 && x2 == x1 - 1)
